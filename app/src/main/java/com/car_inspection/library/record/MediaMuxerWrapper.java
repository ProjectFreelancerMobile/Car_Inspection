...
import com.car_inspection.utils.UtilsKt;
...
public class MediaMuxerWrapper {
	...
	public MediaMuxerWrapper(final Context context, final String _ext) throws IOException {
		...
		try {
			UtilsKt.createFolderPicture(Constanst.Companion.getFolderVideoPath());
			mOutputPath = Constanst.Companion.getFolderVideoPath() + System.currentTimeMillis() + ".mp4";
